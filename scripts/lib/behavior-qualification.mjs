...
const EXPECTED = {
  ...
  author: {
    ...
    delta: { added: ['artifacts/e2e/authored.json', 'artifacts/e2e/authored.matrix.json', 'artifacts/e2e/authored.package.json'], removed: [], modified: [] },
  },
  review: {
  ...
  repair: {
    ...
    delta: { added: ['artifacts/e2e/repaired.json'], removed: [], modified: [] },
  },
  're-review': {
